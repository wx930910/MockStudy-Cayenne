...
public class DefaultEventManagerTest implements EventListener {
	...
	public void testSubjectListenerWouldRegisterListener() {
		...
		eventManager.addListener(new MockListener(eventManager), "processEvent", EventObject.class,
	...
	public void testObjectListenerWouldRegisterListener() {
		...
		eventManager.addListener(listener, "processEvent", EventObject.class, MockListener.mockSubject, this);
		...
		eventManager.addListener(new MockListener(eventManager, this), "processEvent", EventObject.class,
				MockListener.mockSubject, this);
	...
	public void testNonretainedListener() {
		...
		eventManager.addListener(new DefaultEventManagerTest(), "seeNotification", CayenneEvent.class, subject);
	...
	public void testSuccessfulNotificationDefaultSender() throws Exception {
		...
		EventSubject subject = EventSubject.getSubject(this.getClass(), "XXX");
		eventManager.addListener(listener1, "seeNotification", CayenneEvent.class, subject);
		eventManager.addListener(listener2, "seeNotification", CayenneEvent.class, subject);
	...
	public void testSuccessfulNotificationIndividualSender() throws Exception {
		EventSubject subject = EventSubject.getSubject(this.getClass(), "XXX");
		eventManager.addListener(this, "seeNotification", CayenneEvent.class, subject, this);
		eventManager.postEvent(new CayenneEvent(this), subject);
	...
	public void testSuccessfulNotificationBothDefaultAndIndividualSender() throws Exception {
		...
		EventSubject subject = EventSubject.getSubject(this.getClass(), "XXX");
		eventManager.addListener(listener1, "seeNotification", CayenneEvent.class, subject, listener1);
		eventManager.addListener(listener2, "seeNotification", CayenneEvent.class, subject);
	...
	public void testRemoveAll() {
		...
		eventManager.addListener(this, "seeNotification", CayenneEvent.class, subject3, this);
	...
	private static void assertReceivedEvents(final int expected, final DefaultEventManagerTest listener)
			throws Exception {
